...
<div class="container">
    <div class="row">
        ...
        <p>Welcome to Argynza!</p>

        <p>These terms and conditions outline the rules and regulations for the use of Argynza's Website, located at
            https://argynza.com/.</p>

        <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use Argynza if
        ...
        <p>We employ the use of cookies. By accessing Argynza, you agreed to use cookies in agreement with the Argynza's
            Privacy Policy. </p>
        ...
        <p>Unless otherwise stated, Argynza and/or its licensors own the intellectual property rights for all material
            on Argynza. All intellectual property rights are reserved. You may access this from Argynza for your own
            personal use subjected to restrictions set in these terms and conditions.</p>

        <p>You must not:</p>
        <ul>
            <li>Republish material from Argynza</li>
            <li>Sell, rent or sub-license material from Argynza</li>
            <li>Reproduce, duplicate or copy material from Argynza</li>
            <li>Redistribute content from Argynza</li>
        </ul>

        <p>This Agreement shall begin on the date hereof.</p>

        <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in certain
            areas of the website. Argynza does not filter, edit, publish or review Comments prior to their presence on
            the website. Comments do not reflect the views and opinions of Argynza,its agents and/or affiliates.
            Comments reflect the views and opinions of the person who post their views and opinions. To the extent
            permitted by applicable laws, Argynza shall not be liable for the Comments or for any liability, damages or
        ...
        <p>Argynza reserves the right to monitor all Comments and to remove any Comments which can be considered
        ...
        <p>You hereby grant Argynza a non-exclusive license to use, reproduce, edit and authorize others to use,
        ...
        <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us look
            ...
            Argynza; and (d) the link is in the context of general resource information.</p>
        ...
        <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website,
            you must inform us by sending an e-mail to Argynza. Please include your name, your organization name,
        ...
        <p>No use of Argynza's logo or other artwork will be allowed for linking absent a trademark license
            agreement.</p>
