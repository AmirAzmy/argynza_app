              ...
              <tr v-for="mVideo in items.most_watched">
                ...
                <td style="width: 40%">
                  <router-link :to="'/admin/video/edit/'+mVideo.id"
                               class="tx-inverse tx-14 tx-medium d-block">{{ mVideo.title }}
                  </router-link>
                  <span v-if="mVideo.active==1" class="tx-11 d-block">
                                        <span
                                            class="square-8 bg-success mg-l-5 rounded-circle"></span>{{ mVideo.created_at }}
                                    </span>
                  <span v-if="mVideo.active==0" class="tx-11 d-block">
                                        <span
                                            class="square-8 bg-danger mg-l-5 rounded-circle"></span>{{ mVideo.created_at }}
                                    </span>
                </td>
                <td class="tx-12">
              ...
              <tr v-for="dVideo in items.most_downloaded">
                ...
                <td style="width: 40%">
                  ...
                  <span v-if="dVideo.active==1" class="tx-11 d-block">
                                        <span
                                            class="square-8 bg-success mg-l-5 rounded-circle"></span>{{ dVideo.created_at }}
                                    </span>
                  <span v-if="dVideo.active==0" class="tx-11 d-block">
                                        <span
                                            class="square-8 bg-danger mg-l-5 rounded-circle"></span>{{ dVideo.created_at }}
                                    </span>
                </td>
